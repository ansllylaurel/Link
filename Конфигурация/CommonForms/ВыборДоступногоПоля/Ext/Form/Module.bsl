...
Процедура ПриОткрытии(Отказ)
	...
	Если Режим = "Группировка" Тогда
		ЭтаФорма.Элементы.ГруппаСтраницыГруппировка.ТекущаяСтраница = ЭтаФорма.Элементы.ГруппаНастройкаСтруктурыДоступныеПоляГруппировка;
	ИначеЕсли Режим = "Выбор" Тогда
		ЭтаФорма.Элементы.ГруппаСтраницыГруппировка.ТекущаяСтраница = ЭтаФорма.Элементы.ГруппаДоступныеПоляВыбор;
	ИначеЕсли Режим = "Отбор" Тогда
		ЭтаФорма.Элементы.ГруппаСтраницыГруппировка.ТекущаяСтраница = ЭтаФорма.Элементы.ГруппаДоступныеПоляОтбор;
	ИначеЕсли Режим = "Порядок" Тогда
		ЭтаФорма.Элементы.ГруппаСтраницыГруппировка.ТекущаяСтраница = ЭтаФорма.Элементы.ГруппаДоступныеПоляПорядок;
	КонецЕсли;
