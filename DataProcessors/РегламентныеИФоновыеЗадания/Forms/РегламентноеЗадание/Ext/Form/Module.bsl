...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Действие = "Добавить" Тогда
		...
		КонецЦикла;
	Иначе
		Задание = РаботаСРегламентнымиЗаданиями.ПолучитьРегламентноеЗадание(Параметры.Идентификатор);
		...
		СообщенияПользователюИОписаниеИнформацииОбОшибке = РаботаСРегламентнымиЗаданиямиСлужебный.СообщенияИОписанияОшибокРегламентногоЗадания(Задание);
	КонецЕсли;
	...
	Если Действие <> "Изменить" Тогда
		...
		Наименование = ?(
			Действие = "Добавить",
			"",
			РаботаСРегламентнымиЗаданиямиСлужебный.ПредставлениеРегламентногоЗадания(Задание));
	КонецЕсли;
...
Процедура Записать(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("Записать");
	Попытка
...
Процедура ОбновитьЗаголовокФормы()
	...
	Если Действие = "Изменить" Тогда
		Заголовок = РаботаСоСтрокамиКлиентСервер.ПодставитьПараметрыВСтроку(
