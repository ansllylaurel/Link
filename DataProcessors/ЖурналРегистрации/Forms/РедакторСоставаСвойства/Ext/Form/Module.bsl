...
Процедура ВыбратьСоставОтбора(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыбратьСоставОтбора");
	Попытка
		ВыполнитьВыбратьСоставОтбора(ПараметрыСессии);
	Исключение
...
&НаКлиенте
Процедура ВыполнитьВыбратьСоставОтбора(ПараметрыСессии)
