...
Функция ПолучитьЮрФизЛицоПоИНН(ИНН, ИскатьПоДаннымГруппыКомпаний = Ложь)
	...
	// Регистр РеквизитыФизическихЛиц удалён. Везде используем РеквизитыФизическихЛицАнкетные.
	// При поиске по группе компаний: отбор по организации не задаём (Истина), ищем по всем организациям.
