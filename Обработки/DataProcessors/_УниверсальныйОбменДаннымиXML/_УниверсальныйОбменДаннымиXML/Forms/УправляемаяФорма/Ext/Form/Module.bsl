...
Процедура ТестПодключения(Команда)
	...
	ВыполнитьТестПодключения();
	ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьТестПодключения()
...
Процедура ПолучитьИнформациюОФайлеОбмена(Команда)
	...
	ВыполнитьПолучитьИнформациюОФайлеОбмена();
	ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьПолучитьИнформациюОФайлеОбмена()
	АдресФайла = "";
...
Процедура УдалениеОтметитьВсе(Команда)
	...
	ВыполнитьУдалениеОтметитьВсе();
	ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьУдалениеОтметитьВсе()
...
&НаКлиенте
Процедура ВыполнитьУдалениеОтменитьВсе()
	Для Каждого Строка из УдаляемыеДанные.ПолучитьЭлементы() Цикл
		Строка.Пометка = 0;
		УстановитьПометкиПодчиненных(Строка, "Пометка");
	КонецЦикла;
...
Процедура УдалениеУдалить(Команда)
	...
	ВыполнитьУдалениеУдалить();
	ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьУдалениеУдалить()
...
Процедура ВыгрузкаОтметитьВсе(Команда)
	...
	ВыполнитьВыгрузкаОтметитьВсе();
	ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьВыгрузкаОтметитьВсе()
...
&НаКлиенте
Процедура ВыполнитьВыгрузкаОтменитьВсе()
	Для Каждого Строка из Объект.ТаблицаПравилВыгрузки.ПолучитьЭлементы() Цикл
		Строка.Включить = 0;
		УстановитьПометкиПодчиненных(Строка, "Включить");
	КонецЦикла;
...
&НаКлиенте
Процедура ВыполнитьВыгрузкаУстановитьУзелОбмена()
