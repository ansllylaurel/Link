...
Процедура Готово(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("Готово");
	ВыполнитьГотово(ПараметрыСессии);
	ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьГотово(ПараметрыСессии)
	Отказ = Ложь;
	...
	Если Отказ Тогда
		ТекстОшибки = НСтр("ru = 'Не все необходимые шаги выполнены'") + Символы.ПС + Символы.ПС + СтрокаСообщения;
...
Процедура ОткрытьФайл(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ОткрытьФайл");
...
Процедура ВыгрузитьКодОбработчиков(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыгрузитьКодОбработчиков");
	ВыполнитьВыгрузитьКодОбработчиков();
	ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
	
КонецПроцедуры

&НаКлиенте
Процедура ВыполнитьВыгрузитьКодОбработчиков()
