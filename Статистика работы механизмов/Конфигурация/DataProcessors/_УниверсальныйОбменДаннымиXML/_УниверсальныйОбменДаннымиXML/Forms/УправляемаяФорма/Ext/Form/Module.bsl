...
Процедура ТестПодключения(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ТестПодключения");
	Попытка
		ВыполнитьТестПодключения(ПараметрыСессии);
	Исключение
...
&НаКлиенте
Процедура ВыполнитьТестПодключения(ПараметрыСессии)
...
Процедура ПолучитьИнформациюОФайлеОбмена(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ПолучитьИнформациюОФайлеОбмена");
	Попытка
		ВыполнитьПолучитьИнформациюОФайлеОбмена(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьПолучитьИнформациюОФайлеОбмена(ПараметрыСессии)
	АдресФайла = "";
...
Процедура УдалениеОтметитьВсе(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("УдалениеОтметитьВсе");
	Попытка
		ВыполнитьУдалениеОтметитьВсе(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьУдалениеОтметитьВсе(ПараметрыСессии)
...
Процедура УдалениеОтменитьВсе(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("УдалениеОтменитьВсе");
	Попытка
		ВыполнитьУдалениеОтменитьВсе(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьУдалениеОтменитьВсе(ПараметрыСессии)
	Для Каждого Строка из УдаляемыеДанные.ПолучитьЭлементы() Цикл
		Строка.Пометка = 0;
		УстановитьПометкиПодчиненных(Строка, "Пометка");
	КонецЦикла;
...
Процедура УдалениеУдалить(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("УдалениеУдалить");
	Попытка
		ВыполнитьУдалениеУдалить(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьУдалениеУдалить(ПараметрыСессии)
...
Процедура ВыгрузкаОтметитьВсе(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыгрузкаОтметитьВсе");
	Попытка
		ВыполнитьВыгрузкаОтметитьВсе(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьВыгрузкаОтметитьВсе(ПараметрыСессии)
...
Процедура ВыгрузкаОтменитьВсе(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыгрузкаОтменитьВсе");
	Попытка
		ВыполнитьВыгрузкаОтменитьВсе(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьВыгрузкаОтменитьВсе(ПараметрыСессии)
	Для Каждого Строка из Объект.ТаблицаПравилВыгрузки.ПолучитьЭлементы() Цикл
		Строка.Включить = 0;
		УстановитьПометкиПодчиненных(Строка, "Включить");
	КонецЦикла;
...
Процедура ВыгрузкаОчиститьУзлыОбмена(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыгрузкаОчиститьУзлыОбмена");
	Попытка
...
Процедура ВыгрузкаУстановитьУзелОбмена(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыгрузкаУстановитьУзелОбмена");
	Попытка
		ВыполнитьВыгрузкаУстановитьУзелОбмена(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьВыгрузкаУстановитьУзелОбмена(ПараметрыСессии)
...
Процедура СохранитьПараметры(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("СохранитьПараметры");
	Попытка
...
Процедура ВосстановитьПараметры(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВосстановитьПараметры");
	Попытка
...
Процедура НастройкаОтладкиВыгрузки(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("НастройкаОтладкиВыгрузки");
	Попытка
		ВыполнитьНастройкаОтладкиВыгрузки(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьНастройкаОтладкиВыгрузки(ПараметрыСессии)
	#Если ВебКлиент Тогда
		ТекстОшибки = НСтр("ru = 'Возможности отладки недоступны при использовании Веб-клиента'");
	...
	Если Не ПравилаЗагружены Тогда
		...
		ТекстОшибки = НСтр("ru = 'Необходимо прочитать правила обмена'");
		Предупреждение(ТекстОшибки);
		ДобавитьТекстОшибки(ПараметрыСессии, ТекстОшибки);
		Возврат;
...
Процедура НаКлиенте(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("НаКлиенте");
	Попытка
		ВыполнитьНаКлиенте(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьНаКлиенте(ПараметрыСессии)
...
Процедура НаСервере(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("НаСервере");
	Попытка
...
&НаКлиенте
Процедура ВыполнитьНаСервере(ПараметрыСессии)
	Если ЭтоКлиент Тогда
...
Процедура НастройкаОтладкиЗагрузки(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("НастройкаОтладкиЗагрузки");
	Попытка
		ВыполнитьНастройкаОтладкиЗагрузки(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьНастройкаОтладкиЗагрузки(ПараметрыСессии)
	#Если ВебКлиент Тогда
		ТекстОшибки = НСтр("ru = 'Возможности отладки недоступны при использовании Веб-клиента'");
		Предупреждение(ТекстОшибки);
		ДобавитьТекстОшибки(ПараметрыСессии, ТекстОшибки);
	...
	Иначе
		...
		Если ПустаяСтрока(ИмяФайлаОбмена) Тогда
			ТекстОшибки = НСтр("ru = 'Не задан файл обмена данными.'");
			Предупреждение(ТекстОшибки);
			ДобавитьТекстОшибки(ПараметрыСессии, ТекстОшибки);
			Возврат;
		КонецЕсли;
...
Процедура ВыполнитьВыгрузку(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыполнитьВыгрузку");
	Попытка
		ВыполнитьВыгрузкуИзФормы(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
Процедура ВыполнитьЗагрузку(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ВыполнитьЗагрузку");
	Попытка
		ВыполнитьЗагрузкуИзФормы(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
Процедура ПрочитатьПравилаОбмена(Команда)
	...
	ПараметрыСессии = ЗарегистрироватьНовуюСессию("ПрочитатьПравилаОбмена");
	Попытка
		ВыполнитьПрочитатьПравилаОбмена(ПараметрыСессии);
	Исключение
		ДобавитьТекстОшибки(ПараметрыСессии, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗарегистрироватьОкончаниеСессии(ПараметрыСессии);
		Возврат;
...
&НаКлиенте
Процедура ВыполнитьПрочитатьПравилаОбмена(ПараметрыСессии)
	...
	Иначе
		...
		Если ПустаяСтрока(Объект.ИмяФайлаПравилОбмена) Тогда
			ТекстОшибки = НСтр("ru = 'Выберите файл правил обмена.'");
			Предупреждение(ТекстОшибки);
			ДобавитьТекстОшибки(ПараметрыСессии, ТекстОшибки);
			Возврат;
		КонецЕсли;
...
Процедура ЗаполнитьСписокТиповДоступныхДляУдаления()
	...
	Для каждого ОбъектМД Из Метаданные.РегистрыСведений Цикл
		...
		Попытка
			ПравоДоступаУдаление = ПравоДоступа("Удаление", ОбъектМД);
		Исключение
			Информация = ИнформацияОбОшибке();
			ПравоДоступаУдаление = Ложь;
		КонецПопытки;
		
		Если Не ПравоДоступаУдаление Тогда
			Продолжить;
		КонецЕсли;
...
//
&НаКлиенте
Процедура ВыполнитьЗагрузкуИзФормы(ПараметрыСессии = Неопределено)
	...
	Иначе
		...
		Если ПустаяСтрока(ИмяФайлаОбмена) Тогда
			ТекстОшибки = НСтр("ru = 'Выберите файл обмена данными на сервере.'");
			Предупреждение(ТекстОшибки);
			ДобавитьТекстОшибки(ПараметрыСессии, ТекстОшибки);
			Возврат;
		КонецЕсли;
...
&НаКлиенте
Процедура ВыполнитьВыгрузкуИзФормы(ПараметрыСессии = Неопределено)
	...
	Если НЕ Объект.НепосредственноеЧтениеВИБПриемнике и Не ЭтоКлиент Тогда
		...
		Если Врег(СокрЛП(Объект.ИмяФайлаПравилОбмена)) = Врег(СокрЛП(Объект.ИмяФайлаОбмена)) Тогда
			...
			ТекстОшибки = НСтр("ru = 'Файл правил обмена не может совпадать с файлом данных. Выберите другой файл для выгрузки данных.'");
			Предупреждение(ТекстОшибки);
			ДобавитьТекстОшибки(ПараметрыСессии, ТекстОшибки);
			Возврат;
